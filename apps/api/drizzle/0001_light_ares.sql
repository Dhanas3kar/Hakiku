DO $$ BEGIN
 CREATE TYPE "public"."confession_status" AS ENUM('DRAFT', 'PENDING_MODERATION', 'PUBLISHED', 'REJECTED', 'REMOVED', 'EXPIRED');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."connection_request_status" AS ENUM('PENDING', 'ACCEPTED', 'REJECTED', 'CANCELLED');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."event" AS ENUM('OTP_SENT', 'OTP_VERIFIED', 'OTP_FAILED', 'LOGIN_SUCCESS', 'LOGIN_FAILED', 'LOGOUT', 'TOKEN_REFRESHED');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."media_type" AS ENUM('IMAGE', 'VIDEO');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."message_type" AS ENUM('TEXT', 'IMAGE', 'VIDEO', 'FILE', 'SYSTEM');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."notification_type" AS ENUM('FOLLOW', 'CONNECTION_REQUEST', 'CONNECTION_ACCEPTED', 'POST_LIKE', 'POST_COMMENT', 'COMMENT_REPLY', 'SYSTEM', 'MESSAGE');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."outbox_status" AS ENUM('PENDING', 'PROCESSING', 'PROCESSED', 'FAILED');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."poll_status" AS ENUM('PUBLISHED', 'CLOSED', 'REMOVED');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."post_visibility" AS ENUM('PUBLIC', 'CONNECTIONS_ONLY', 'PRIVATE');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."profile_visibility" AS ENUM('PUBLIC', 'CONNECTIONS_ONLY', 'PRIVATE');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."report_status" AS ENUM('PENDING', 'REVIEWED', 'RESOLVED', 'DISMISSED');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."report_target_type" AS ENUM('CONFESSION', 'POLL', 'POST', 'COMMENT', 'USER');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."status" AS ENUM('ACTIVE', 'SUSPENDED', 'BANNED', 'DEACTIVATED');
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
...
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "confessions" ADD CONSTRAINT "confessions_author_id_users_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
...
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "pending_media_uploads" ADD CONSTRAINT "pending_media_uploads_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
...
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "profile_interests" ADD CONSTRAINT "profile_interests_profile_id_profiles_id_fk" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "profile_interests" ADD CONSTRAINT "profile_interests_interest_id_interests_id_fk" FOREIGN KEY ("interest_id") REFERENCES "public"."interests"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
DO $$ BEGIN
...
EXCEPTION WHEN duplicate_object THEN null; END $$;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_blocks_blocked_id" ON "blocks" USING btree ("blocked_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_comments_post_created" ON "comments" USING btree ("post_id","created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_comments_author" ON "comments" USING btree ("author_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_reports_type_status_created" ON "community_reports" USING btree ("target_type","status","created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_confessions_status_published" ON "confessions" USING btree ("status","published_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_confessions_campus_published" ON "confessions" USING btree ("campus","published_at");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "unique_pending_connection_request" ON "connection_requests" USING btree ("sender_id","receiver_id") WHERE "connection_requests"."status" = 'PENDING';--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_connection_requests_receiver_status" ON "connection_requests" USING btree ("receiver_id","status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_connection_requests_sender_status" ON "connection_requests" USING btree ("sender_id","status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_connections_user_a" ON "connections" USING btree ("user_a_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_connections_user_b" ON "connections" USING btree ("user_b_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_conversation_participants_user_updated" ON "conversation_participants" USING btree ("user_id","last_read_at");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "idx_conversations_unique_participants" ON "conversations" USING btree ("user_a_id","user_b_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_follows_following_id" ON "follows" USING btree ("following_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "idx_interests_name_lower" ON "interests" USING btree (lower("name"));--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_message_media_order" ON "message_media" USING btree ("message_id","display_order");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_messages_conversation_created_id" ON "messages" USING btree ("conversation_id","created_at","id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_messages_sender_created" ON "messages" USING btree ("sender_id","created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_messages_reply_to" ON "messages" USING btree ("reply_to_message_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_notification_outbox_pending" ON "notification_outbox" USING btree ("status","available_at") WHERE "notification_outbox"."status" IN ('PENDING', 'PROCESSING');--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_notifications_recipient_inbox" ON "notifications" USING btree ("recipient_id","created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_notifications_recipient_unread" ON "notifications" USING btree ("recipient_id","is_read");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_pending_media_user_attached" ON "pending_media_uploads" USING btree ("user_id","is_attached");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_polls_status_created" ON "polls" USING btree ("status","created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_polls_ends_at" ON "polls" USING btree ("ends_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_post_likes_user" ON "post_likes" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_post_media_order" ON "post_media" USING btree ("post_id","display_order");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_posts_author_created" ON "posts" USING btree ("author_id","created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_posts_created_at" ON "posts" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_posts_active" ON "posts" USING btree ("author_id","deleted_at");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "idx_profiles_username_lower" ON "profiles" USING btree (lower("username"));--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_profiles_campus_dept" ON "profiles" USING btree ("campus","department");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_profiles_batch_grad" ON "profiles" USING btree ("batch_year","graduation_year");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "idx_skills_name_lower" ON "skills" USING btree (lower("name"));
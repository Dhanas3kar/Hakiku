...
import { messages, messageMedia, conversationParticipants } from '../../db/schema';
...
export class MessageQueryService {
   ...
   */
  async listMessages(userId: string, conversationId: string, cursorAt?: string, cursorId?: string, limit = 50) {
    // 1. Ensure access

...
export function Sidebar() {
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-border bg-surface px-4 py-6 md:flex h-[100dvh] sticky top-0 overflow-y-auto">
      ...
      <nav className="flex flex-1 flex-col gap-1">
        {navItems.map((item) => (
          <Link
            ...
            activeProps={{ className: 'bg-surface-muted text-foreground font-semibold', 'aria-current': 'page' }}
          >
